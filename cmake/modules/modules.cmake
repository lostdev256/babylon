...
function(babylon_register_module BABYLON_UNIT_NAME)
    ...
    set(BABYLON_UNIT_DEPEND_UNITS ${ARG_DEPEND_UNITS})
    ...
    set(${BABYLON_UNIT_NAME}_BABYLON_UNIT_DEPEND_UNITS ${BABYLON_UNIT_DEPEND_UNITS} CACHE INTERNAL "")
...
function(babylon_link_depend_modules UNIT_NAME DEPEND_UNITS)
    # TODO:
    foreach(DEPEND_UNIT ${DEPEND_UNITS})
        babylon_link_depend_module(${UNIT_NAME} ${DEPEND_UNIT})
    endforeach()
endfunction()

# Link depend Babylon module
function(babylon_link_depend_module BABYLON_UNIT_NAME DEPEND_UNIT)
    if(NOT BABYLON_UNIT_NAME)
    ...
    if(NOT DEPEND_UNIT IN_LIST BABYLON_MODULES_AVAILABLE)
        babylon_log_error("Depend module (${DEPEND_UNIT}) doesn't exist")
        return()
    endif()

    if(NOT DEPEND_UNIT IN_LIST BABYLON_MODULES_ENABLED)
        babylon_log_error("Depend module (${DEPEND_UNIT}) doesn't enabled")
        return()
    endif()

    foreach(DIR ${${DEPEND_UNIT}_BABYLON_UNIT_INCLUDE_DIRS})
        target_include_directories(${BABYLON_UNIT_NAME} PRIVATE ${DIR})
    endforeach()

    target_link_libraries(${BABYLON_UNIT_NAME} PUBLIC ${${DEPEND_UNIT}_BABYLON_UNIT_OUTPUT_NAME})
    add_dependencies(${BABYLON_UNIT_NAME} ${DEPEND_UNIT})
endfunction()
